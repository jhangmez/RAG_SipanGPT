...
llm= Ollama(model="hf.co/ussipan/SipanGPT-0.3-Llama-3.2-1B-GGUF:Q4_K_M", temperature=0.3, num_predict=512)
...
raw_prompt= PromptTemplate.from_template("""
    <s>[INST] Usted es un asistente técnico que proporciona respuestas basadas únicamente en la información proporcionada. Si no sabe la respuesta con la información proporcionada, sea honesto y responda: "Lo siento, no sé la respuesta a esta pregunta", recuerda dar todas tus respuestas en español. [/INST] </s>
    [INST] {input}
            Context: {context}
            Answer:
    [/INST]
